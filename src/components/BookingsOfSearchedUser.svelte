                ...
                <div class="grid grid-cols-3 grid-rows-4 gap-1 px-2 w-full" >
                    ...
                    <div class="col-span-3">
                        <div class="flex items-center">
                            <MapPin size=18 />
                            <span class="ml-2">{booking.desk?.map?.floor?.building?.location?.locationname}</span>
                        </div>                    
                    </div>
                    ...
                    <div>
                        <div class="flex items-center">
                            <Building2 size=18/>
                            <span class="ml-2">{booking.desk?.map?.floor?.building.buildingname.split(' ')[1]}</span>
                        </div>
                    </div>
                    <div>
                        <div class="flex items-center">
                            <Building size=18/>
                            <span class="ml-2">{booking.desk?.map?.floor?.floorname.charAt(0)}</span>
                        </div>
                    </div>
                    <div>
                        <div class="flex items-center">
